...
import '../../features/reference/screens/session_ledger_screen.dart';
...
class AppRoutes {
  ...
  static void toAiImport(BuildContext context, {String? course, bool redirectOnSave = false}) {
    AppShellNavigator.navigatorKey.currentState!.push(
      CupertinoPageRoute(
  ...
  static void toRecipeComparison(BuildContext context, {Recipe? prefilledRecipe, int targetSlot = 1, bool resetState = false}) {
    AppShellNavigator.navigatorKey.currentState!.push(
      CupertinoPageRoute(
  ...
  static void toSessionLedger(BuildContext context) {
    AppShellNavigator.navigatorKey.currentState!.push(
      CupertinoPageRoute(
        builder: (_) => const SessionLedgerScreen(),
      ),
    );
  }
