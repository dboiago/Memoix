...
Pizza _pizzaDeserialize(
  ...
  object.source =
      _PizzasourceValueEnumMap[reader.readStringOrNull(offsets[9])] ??
          PizzaSource.memoix;
...
extension PizzaQueryFilter on QueryBuilder<Pizza, Pizza, QFilterCondition> {
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsElementGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsElementLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsElementBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsElementStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsElementEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsElementContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsElementMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsElementIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'toppings',
        value: '',
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'toppings',
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'toppings',
        0,
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'toppings',
        0,
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pizza, Pizza, QAfterFilterCondition> toppingsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PizzaQueryWhereDistinct on QueryBuilder<Pizza, Pizza, QDistinct> {
  ...
  QueryBuilder<Pizza, Pizza, QDistinct> distinctByToppings() {
    return QueryBuilder.apply(this, (query) {
...
extension PizzaQueryProperty on QueryBuilder<Pizza, Pizza, QQueryProperty> {
  ...
  QueryBuilder<Pizza, List<String>, QQueryOperations> toppingsProperty() {
    return QueryBuilder.apply(this, (query) {
