...
const ShoppingListSchema = CollectionSchema(
  ...
  links: {},
  embeddedSchemas: {r'ShoppingItem': ShoppingItemSchema},
...
void _shoppingListSerialize(
  ...
  writer.writeLong(offsets[0], object.checkedCount);
  ...
  writer.writeStringList(offsets[6], object.recipeIds);
...
ShoppingList _shoppingListDeserialize(
  ...
  object.recipeIds = reader.readStringList(offsets[6]) ?? [];
...
extension ShoppingListQueryFilter
  ...
  QueryBuilder<ShoppingList, ShoppingList, QAfterFilterCondition>
      checkedCountEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'checkedCount',
        value: value,
      ));
    });
  }
...
extension ShoppingListQuerySortBy
  ...
  QueryBuilder<ShoppingList, ShoppingList, QAfterSortBy> sortByCheckedCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'checkedCount', Sort.asc);
    });
  }

  QueryBuilder<ShoppingList, ShoppingList, QAfterSortBy>
      sortByCheckedCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'checkedCount', Sort.desc);
    });
  }
  ...
  QueryBuilder<ShoppingList, ShoppingList, QAfterSortBy> sortByIsComplete() {
    return QueryBuilder.apply(this, (query) {
...
extension ShoppingListQuerySortThenBy
  ...
  QueryBuilder<ShoppingList, ShoppingList, QAfterSortBy> thenByCheckedCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'checkedCount', Sort.asc);
    });
  }
  ...
  QueryBuilder<ShoppingList, ShoppingList, QAfterSortBy> thenByIsComplete() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isComplete', Sort.asc);
    });
  }
...
extension ShoppingListQueryWhereDistinct
  ...
  QueryBuilder<ShoppingList, ShoppingList, QDistinct> distinctByCheckedCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'checkedCount');
    });
  }
  ...
  QueryBuilder<ShoppingList, ShoppingList, QDistinct> distinctByIsComplete() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ShoppingList, ShoppingList, QDistinct> distinctByRecipeIds() {
    return QueryBuilder.apply(this, (query) {
...
extension ShoppingListQueryProperty
  ...
  QueryBuilder<ShoppingList, int, QQueryOperations> checkedCountProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'checkedCount');
    });
  }
  ...
  QueryBuilder<ShoppingList, bool, QQueryOperations> isCompleteProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isComplete');
    });
  }

  QueryBuilder<ShoppingList, List<ShoppingItem>, QQueryOperations>
      itemsProperty() {
    return QueryBuilder.apply(this, (query) {
...
void _shoppingItemSerialize(
  ...
  writer.writeString(offsets[4], object.recipeSource);
...
ShoppingItem _shoppingItemDeserialize(
  ...
  object.recipeSource = reader.readStringOrNull(offsets[4]);
...
extension ShoppingItemQueryFilter
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QAfterFilterCondition> amountMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QAfterFilterCondition> unitIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'unit',
      ));
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QAfterFilterCondition> unitEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QAfterFilterCondition> unitLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QAfterFilterCondition> unitBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QAfterFilterCondition> unitEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QAfterFilterCondition> unitContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<ShoppingItem, ShoppingItem, QAfterFilterCondition> unitMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
