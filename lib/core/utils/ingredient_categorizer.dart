...
class IngredientService {
  ...
  void _injectFallbackData() {
    ...
    final fallback = <String, int>{
      ...
      'beet': IngredientCategory.produce.index,
      'bok choy': IngredientCategory.produce.index,
      'napa cabbage': IngredientCategory.produce.index,
      'fennel': IngredientCategory.produce.index,
      'artichoke': IngredientCategory.produce.index,
      'okra': IngredientCategory.produce.index,
      'watercress': IngredientCategory.produce.index,
      'arugula': IngredientCategory.produce.index,
      'endive': IngredientCategory.produce.index,
      'radicchio': IngredientCategory.produce.index,
      'rhubarb': IngredientCategory.produce.index,
      'fig': IngredientCategory.produce.index,
      'persimmon': IngredientCategory.produce.index,
      'lychee': IngredientCategory.produce.index,
      'dragon fruit': IngredientCategory.produce.index,
      ...
      'lardon': IngredientCategory.meat.index,
      'salami': IngredientCategory.meat.index,
      'pepperoni': IngredientCategory.meat.index,
      'guanciale': IngredientCategory.meat.index,
      'bresaola': IngredientCategory.meat.index,
      'nduja': IngredientCategory.meat.index,
      // Poultry
      ...
      'white bread': IngredientCategory.grain.index,
      'sourdough': IngredientCategory.grain.index,
      'brioche': IngredientCategory.grain.index,
      'ciabatta': IngredientCategory.grain.index,
      'focaccia': IngredientCategory.grain.index,
      'pita': IngredientCategory.grain.index,
      'naan': IngredientCategory.grain.index,
      'baguette': IngredientCategory.grain.index,
      ...
      'five spice': IngredientCategory.spice.index,
      'chinese five spice': IngredientCategory.spice.index,
      'gochugaru': IngredientCategory.spice.index,
      'marjoram': IngredientCategory.spice.index,
      'sumac': IngredientCategory.spice.index,
      'za\'atar': IngredientCategory.spice.index,
      'zaatar': IngredientCategory.spice.index,
      'ras el hanout': IngredientCategory.spice.index,
      ...
      'fenugreek': IngredientCategory.spice.index,
      'msg': IngredientCategory.spice.index,
      'smoked paprika': IngredientCategory.spice.index,
      'ancho chili': IngredientCategory.spice.index,
      'chipotle powder': IngredientCategory.spice.index,
      ...
      'bonito': IngredientCategory.pantry.index,
      ...
      'vermouth': IngredientCategory.alcohol.index,
      'aperol': IngredientCategory.alcohol.index,
      'cointreau': IngredientCategory.alcohol.index,
      'grand marnier': IngredientCategory.alcohol.index,
      'triple sec': IngredientCategory.alcohol.index,
      'limoncello': IngredientCategory.alcohol.index,
      'chartreuse': IngredientCategory.alcohol.index,
      'amaretto': IngredientCategory.alcohol.index,
      'absinthe': IngredientCategory.alcohol.index,
      'grappa': IngredientCategory.alcohol.index,
