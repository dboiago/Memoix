...
KEYWORD_RULES = [
    ...
    (["starch water"],          "pantry"),
    (["sticky rice flour"],     "flour"),
    (["wakame"],                "pantry"),
    (["brandied cherry"],       "pantry"),
    (["liquid smoke"],          "pantry"),
    ...
    (["kimchi"],                "produce"),
    (["sauerkraut"],            "produce"),
    (["pickled ginger"],        "produce"),
    (["preserved lemon"],       "produce"),
    
    # Asian specialty produce/ingredients
    (["gai lan"],               "produce"),
    (["yu choy"],               "produce"),
    (["chinese broccoli"],      "produce"),
    (["water spinach"],         "produce"),
    ...
    (["thai basil"],            "produce"),
    (["shiso"],                 "produce"),
    (["vietnamese mint"],       "produce"),
    (["curry leaf"],            "produce"),
    
    # Specialty pantry - Asian
    (["fish sauce"],            "condiment"),
    (["oyster sauce"],          "condiment"),
    (["black bean sauce"],      "condiment"),
    (["xo sauce"],              "condiment"),
    ...
    (["furikake"],              "spice"),
    (["bonito flakes"],         "pantry"),
    (["katsuobushi"],           "pantry"),
    (["msg"],                   "spice"),
    (["monosodium glutamate"],  "spice"),
    
    # Molecular gastronomy / professional ingredients
    (["xanthan gum"],           "pantry"),
    (["agar agar"],             "pantry"),
    (["guar gum"],              "pantry"),
    (["gelatin"],               "pantry"),
    (["pectin"],                "pantry"),
    (["methylcellulose"],       "pantry"),
    (["sodium alginate"],       "pantry"),
    (["calcium chloride"],      "pantry"),
    (["citric acid"],           "pantry"),
    (["ascorbic acid"],         "pantry"),
    (["tartaric acid"],         "pantry"),
    (["maltic acid"],           "pantry"),
    (["lecithin"],              "pantry"),
    (["glucose syrup"],         "sugar"),
    (["invert sugar"],          "sugar"),
    ...
    # Professional baking ingredients
    (["bread flour"],           "flour"),
    (["cake flour"],            "flour"),
    (["pastry flour"],          "flour"),
    (["tipo 00 flour"],         "flour"),
    ...
    (["fresh yeast"],           "leavening"),
    (["compressed yeast"],      "leavening"),
    (["baking powder"],         "leavening"),
    (["baking soda"],           "leavening"),
    (["cream of tartar"],       "leavening"),
    ...
    (["dutch cocoa"],           "sugar"),
    (["cacao nibs"],            "sugar"),
    (["couverture chocolate"],  "sugar"),
    (["valrhona"],              "sugar"),
    (["callebaut"],             "sugar"),
    
    # Specialty cheeses (professional)
    ...
    (["limoncello"], "alcohol"),
    (["chartreuse"], "alcohol"),
    (["maraschino liqueur"], "alcohol"),
    (["creme de violette"], "alcohol"),
    (["lillet blanc"], "alcohol"),
